...
function setGameOver() {
    guessField.diseble =true;
    guessSubmit.diseble = true;
    resetButton = documnet.createElement("Buton");
    resetButton.textContent = "comenzare de nuevo";
 ...
 function resetgame(){
     ...
     const resetPares =document.querySelectorAll(".resultPares p");
     for(const resetPare of resetPares) {
        resetButton.textContent = "";
     }
     resetButton.parenNode.removechild(resetButton);
      
     guessField.diseble =false;
     guessSubmit.diseble = false;
     guessField.value ="";
     guessField.focus();
